    ...
    <div class="container1 d-flex justify-content-center align-items-center">
        ...
        <form>
            ...
            <div class="form-group position-relative">
                ...
                <input type="text" id="formName" class="form-control form-control-lg thick my-3" placeholder="Name">
            </div>
            ...
            <div class="form-group position-relative">
                ...
                <input type="email" id="formEmail" class="form-control form-control-lg thick my-3" placeholder="E-mail">
            </div>

            <!-- Message -->
            <div class="form-group message">
                <textarea id="formMessage" class="form-control form-control-lg my-3" rows="7" placeholder="Message"></textarea>
            </div>
